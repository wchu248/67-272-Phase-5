module Contexts
  module OrderItems
    ...
    def create_order_items
      @karen_o1_1 = FactoryGirl.create(:order_item, order: @karen_o1, item: @vinyl_green, quantity: 5, shipped_on: 4.days.ago.to_date)
      @karen_o1_2 = FactoryGirl.create(:order_item, order: @karen_o1, item: @basic_pieces, quantity: 5, shipped_on: 4.days.ago.to_date)
